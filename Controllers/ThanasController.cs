...
namespace Blood_Page.Controllers
{
    public class ThanasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,District_ID,Name,Status")] Thana thana)
        {
            ...
            ViewBag.District_ID = new SelectList(db.Districts, "ID", "Name", thana.District_ID);
            return View(thana);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,District_ID,Name,Status")] Thana thana)
        {
            if (ModelState.IsValid)
            {
